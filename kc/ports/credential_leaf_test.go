...
// no `import "github.com/algo2go/kite-mcp-bootstrap/kc"` (parent kc
...
//
// Adding `import "github.com/algo2go/kite-mcp-bootstrap/kc"` to
...
func TestCredentialPortLeafStability(t *testing.T) {
	const target = "github.com/algo2go/kite-mcp-bootstrap/kc"
