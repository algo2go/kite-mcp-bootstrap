...
const kcParentImportPath = "github.com/algo2go/kite-mcp-bootstrap/kc"

// leafPorts lists the four port files that MUST be free of any
// `import "github.com/algo2go/kite-mcp-bootstrap/kc"` line. Adding to
...
// "github.com/algo2go/kite-mcp-bootstrap/kc"` to one of the listed
