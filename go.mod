...
require (
	...
	github.com/algo2go/kite-mcp-bootstrap/app/providers v0.2.0
	github.com/algo2go/kite-mcp-bootstrap/plugins v0.2.0
	github.com/algo2go/kite-mcp-bootstrap/testutil v0.2.0
