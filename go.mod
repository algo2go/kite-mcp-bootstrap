...
require (
	...
	github.com/algo2go/kite-mcp-bootstrap/plugins v0.3.0
	github.com/algo2go/kite-mcp-bootstrap/testutil v0.3.0
	...
	github.com/algo2go/kite-mcp-tools-common v0.1.0
